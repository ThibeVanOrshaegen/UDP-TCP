...
int initialization()
{
	...
	int getaddrinfo_return = getaddrinfo( "::1", "24085", &internet_address_setup, &internet_address_result );
...
void execution( int internet_socket )
{
	...
	number_of_bytes_send = send( internet_socket, "Hello TCP world!\n\n", 16, 0 );
	...
	else
	{
        ...
        char result_str[100];
        snprintf(result_str, 5 , "%f" , result_str);
